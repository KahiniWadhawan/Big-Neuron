...
def get_follower_ids(centre, max_depth=1, current_depth=0, taboo_list=[]):
    ...
    try:
        ...
        if not os.path.exists(userfname):
            ...
            while True:
                ...
                try:
                    ...
                    user = d
                    print('___________4____________')
                    break
        ...
        friendids = []
        print('___________5____________')
        ...
        if not screen_name.startswith('TED'):
            if not os.path.exists(fname):
                ...
                with open(fname, 'w') as outf:
                    ...
                    print('___________6____________')
                    friend_count = 0
                    while True:
                        try:
                            friend = c.next()
                            ...
                            outf.write('%s\t%s\t%s\n' % params)
                            friend_count += 1
                            print('___________7____________')
                ...
                print('___________8____________')
            ...
            print('___________9____________')
    ...
    print('___________10____________')
    return taboo_list
