(function() {
  ...
  k.AmSlicedChart = k.Class({
    ...
    formatString: function(a, b, c) {
      ...
      this.pf.precision = d; - 1 != a.indexOf("[[") && (a = k.formatDataContextValue(a,
        b.dataContext));
    ...
    parseData: function() {
      ...
      if (void 0 !== b) {
        ...
        for (g = 0; g < c; g++) {
          ...
          f.title = h;
          f.pulled =
            k.toBoolean(e[this.pulledField], !1);
    ...
    removeSmallSlices: function() {
      var a = this.chartData,
        b;
      for (b = a.length - 1; 0 <= b; b--) a[b].percents <
  ...
  k.AmPieChart = k.Class({
          ...
          for (var D, h = 0; h < a.length; h++)
            if (e = a[h], !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents)) {
              ...
              if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
                ...
                t = e.labelColor;
                t || (t = this.color);
                "" !== m && (m = k.wrappedText(c, m, t, this.fontFamily, this.fontSize, w, !1, this.maxLabelWidth), k.setCN(this, m, "pie-label"), k.setCN(this, m, e.className, !0), m.translate(r + 1.5 * u, E), m.node.style.pointerEvents = "none", e.ty = E, e.textX = r + 1.5 * u, v.push(m), this.axesSet.push(v),
                  e.labelSet = v, e.label = m);
                e.tx = r;
                e.tx2 = r + u;
                e.tx0 = A + p * l;
                e.ty0 = B + C * l
    ...
    checkOverlapping: function(a, b, c, d, g) {
      ...
      if (n) {
        ...
        !0 === f && 100 > g && isNaN(b.labelRadius) && (f = b.ty + 3 * b.iy, b.ty = f, n.translate(b.textX,
