...
window.onclick = function(event) {
    console.log("Just clicked")
          ...
          xhttp3.onreadystatechange = function() {
            ...
            xhttp1.open("GET", "realtimesentiment.json?something="+(Math.random()*10).toString(), true);
            xhttp2.open("GET", "realtimetwitter.json?something="+(Math.random()*10).toString(), true);
